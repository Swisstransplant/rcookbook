...
The source code for `swt` is maintained on GitHub and can be accessed [here](https://github.com/Swisstransplant/swt). Additionally, a [package manual](https://github.com/Swisstransplant/swt/blob/08f8a20aca6c00c7e47d7010613190fe3be99490/manual/swt.pdf) is available for reference.
...
Click **New Project...** then choose **New Directory**, and select the **Swisstransplant Project** at the bottom of the list.

![](../images/swt_quarto_template.png)

### Writing a report

The Swisstransplant Quarto template is written in [markdown](https://quarto.org/docs/authoring/markdown-basics.html). It is possible to add [callout blocks](https://quarto.org/docs/authoring/callouts.html) to highlight important information.
